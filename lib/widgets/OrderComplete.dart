...
class OrderSuccess extends StatefulWidget {
  ...
  OrderSuccess({Key key, this.deliveryCharge}) : super(key: key);
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  Text("₹" + pro.subtotal.toStringAsFixed(1))
                                ],
                              ),
                              SizedBox(height: 3),
                              Row(
                                children: <Widget>[
                                  ...
                                  Text("+₹" + widget.deliveryCharge.toStringAsFixed(1))
                                ],
                              ),
                              SizedBox(height: 3),
                              Row(
                                children: <Widget>[
                                  ...
                                  Text("-₹" + pro.discount.toStringAsFixed(1))
                                ],
                              ),
                              Divider(height: 30),
                              Row(
